...
<nav>
<ul>
<li><a href="create" class="create">新規登録<i class="fa fa-plus-circle" aria-hidden="true"></i></a></li> 
...
<td><a href="/edit/{{$user->ID}}" class="edit">編集</a><i class="fa fa-pencil" aria-hidden="true"></i></td>
