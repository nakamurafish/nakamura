...
@section('content')
<div class="wrapper">
<h2 class="h2_title">確認フォーム</h2>
<form action="create/getIndex" method="POST">
...
<!-- CONFIRMATION -->
<ul class="column confirmation">
<li class="column_left"></li>
<li class="column_right">この内容でよろしいですか？</li>
</ul>
...
<ul class="ul_button">
<li class="li_button"><input type="submit" value="送信" class="button"></li>
